...
<<<<<<< HEAD
"text": ({label,name,classes,length,required=true})=><label >{label?label:"no label"}<input  maxlength={length} name={name} 
className={classes} required={required} onChange={(e)=>console.log("")} /></label>,
"password":({label,name,length,classes,required=true})=><label >{label?label:"no label"}<input maxlength={length} type="password" name={name} className={classes} required={required}/></label>,
=======
